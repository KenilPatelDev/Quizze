package com.appspouch.quizze.Create_Quiz;
...
import com.appspouch.quizze.Model.Question;
...
public class Custom_quiz extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dialogvView = inflater.inflate(R.layout.quiz_set_dialog_custom,null);
        ...
        fl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(jsonArray.length()!=0)
                {
                    ...
                    View promptsView = li.inflate(R.layout.quiz_set_dialog_custom, null);
